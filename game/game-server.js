...
chatBoxObserver.observe(document.getElementById('chatBox'));
    ...
    onValue(leaderboardRef, (snapshot) => {
        ...
        users.forEach((userData, index) => {
            ...
            coinsDiv.innerHTML = `${formatNumber(userData.coins)} <img src='coin.png' style='width: calc(var(--base-size) * 0.9); margin: 0; margin-left: calc(var(--base-size) * 0.1); transform: translateY(20%);'/>`;
...
function updateLeaderboardPrestigeCount() {
    ...
    onValue(leaderboardRef, (snapshot) => {
        ...
        users.forEach((userData, index) => {
            ...
            prestigeCountDiv.innerHTML = `${formatNumber(userData.prestigeCount)} <img src='prestige.png' style='width: calc(var(--base-size) * 0.9); margin: 0; margin-left: calc(var(--base-size) * 0.1); transform: translateY(20%);'/>`;
